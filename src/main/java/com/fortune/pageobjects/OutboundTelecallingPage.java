package com.fortune.pageobjects;
...
public class OutboundTelecallingPage extends BasePage {
	...
	@FindBy(xpath ="//button[normalize-space()='Achivements']")
	private WebElement achivementsMenu;
	
	@FindBy(xpath ="//label[text()='Achivements']")
	private WebElement achivementsMenuLable;
	
	@FindBy(xpath ="//i[@class='mdi mdi-close text-white h4']")
	private WebElement achivementsMenuCrossIcon;
	
	@FindBy(xpath ="//button[@role='menuitem'][normalize-space()='Catalog']")
	private WebElement milestoneCatalogMenu;
	
	@FindBy(xpath ="//label[text()='Catalog']")
	private WebElement milestoneCatalogLable;
	
	@FindBy(xpath ="//i[@class='mdi mdi-close text-white h4']")
	private WebElement milestoneCatalogCrossIcon;
	...
	@FindBy(xpath="//*[@id=\"getClaimVerifyDetails\"]/div/div/div/div[2]/div/table/tbody/tr")
	private List<WebElement> rowsOfClaimVerificationDetails;
	
	@FindBy(xpath="//*[@id=\"getClaimVerifyDetails\"]/div/div/div/div[1]/div[3]/marquee/span")
	private WebElement pendingClaimCountText;
	
	@FindBy(xpath="//*[@id=\"getClaimVerifyDetails\"]/div/div/div/div[2]/div/table/tbody/tr[1]/td[6]/button")
	private WebElement fristRowVerifyButtonOfClaimVerification;
...
//	}
	...
	public void clickOnAchivementsMenu()
	{
		click(achivementsMenu);
	}
	...
	public void clickOnAchivementsMenuCrossIcon() {
		try {
	...
	public void clickOnMilestoneCatalogMenu()
	{
		click(milestoneCatalogMenu);
	}
	...
	public void clickOnMilestoneCatalogMenuCrossIcon()
	{
		click(milestoneCatalogCrossIcon);
	}
	...
	public int getRowCountOfPendingClaim()
	{
		try {
			Thread.sleep(6000);
		} catch (InterruptedException e) {
		...
		int pendingClaimCount=rowsOfClaimVerificationDetails.size();
		return pendingClaimCount;
	}
	
	public String getTextOfPendingClaimCount()
	{
		waitVisibilityOf(pendingClaimCountText);
		return pendingClaimCountText.getText();
	}
	
	public int getTextOfPendingClaimCountInInteger()
	{
		waitVisibilityOf(pendingClaimCountText);
		String stringPendingClaims =pendingClaimCountText.getText();
		...
		return actualPendingClaimCount;
	}
	
	public void clickOnFristRowVerifyBtnOfClaimVerification()
	{
		click(fristRowVerifyButtonOfClaimVerification);
	}
...
//	
	...
	public String getClaimVefDetailsClaimIdAndTaskNo(int rowIndex)
	{
		By claimIdAndTaskNo=By.xpath("//*[@id='getClaimVerifyDetails']/div/div/div/div[2]/div/table/tbody/tr["+rowIndex+"]/td[1]");
		WaitVisibliltyOfLocated(claimIdAndTaskNo);
		return driver.findElement(claimIdAndTaskNo).getText().replaceAll("\\s", "");
	}
	...
	public String getClaimVerificationClaimIdAndTaskNo()
	{
		waitVisibilityOf(claimVerificationLabel);
		String inputString =claimVerificationLabel.getText();
	    String outputString=null;
	       // Regular expression to capture the desired portion
	        String regex = "(C\\d+ \\( TS\\d+ \\))";
	        ...
	        if (matcher.find()) {
	            outputString=matcher.group(0).replaceAll("\\s", "");
	            System.out.println("ClaimVerificationClaimIdAndTaskNo : "+outputString);
	        }
	        return outputString;
